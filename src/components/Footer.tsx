...
export default function Footer() {
  return (
    <section className="ft nd" aria-label="Site footer">
      <div className="ftcta-inner">
        <div className="ftcta-text">
          <p className="ftcta-eyebrow">Ready to get started?</p>
          <h2 className="ftcta-h">Let&apos;s resolve your legal matter — remotely.</h2>
          <p className="ftcta-sub">
            Verified Indian advocates. Transparent process. No office visits required.
          </p>
        </div>
        <div className="ftcta-actions">
          <a
            href="https://wa.me/919974772427?text=Hello%2C%20I%20would%20like%20a%20free%20legal%20consultation."
            target="_blank"
        ...
        <div className="ftcta-sm">
          <div className="ftcta-sm-item">
            <span className="ftcta-sm-n">40+</span>
            <span className="ftcta-sm-l">Countries served</span>
          </div>
      ...
      <nav className="fln" aria-label="Footer navigation">
        ...
        <a
          href="https://mail.google.com/mail/?view=cm&to=advocatepulkitrastogi@gmail.com&su=Legal%20Enquiry"
          target="_blank"
          rel="noopener noreferrer"
          className="flnk"
        >
